// Shared helpers for the evidence-02 capture. Render and measure only; no scoring.
...
export const OUT = `${ROOT}/eval/evidence-02`
export const RUN1 = `${ROOT}/eval/evidence-01`
...
export async function newContext(browser, { reducedMotion } = {}) {
