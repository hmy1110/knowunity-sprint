// Shared helpers for the evidence-03 capture. Render and measure only; no scoring.
...
export const OUT = `${ROOT}/eval/evidence-03`
export const RUN2 = `${ROOT}/eval/evidence-02`
