// Shared helpers for the evidence-05 capture. Render and measure only; no scoring.
...
export const OUT = `${ROOT}/eval/evidence-05`
export const RUN2 = `${ROOT}/eval/evidence-04`
