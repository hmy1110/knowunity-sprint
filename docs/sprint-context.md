...
- **2026-09-21, Mia: the prototype keeps what Figma doesn't have.** The typed Hinted/retry/Revealed states, the "Continue" study plan label, the disabled Skip, the mixed review Summary, "Let’s go again, Mia.", the position-based table divider, the scrolling middle and the unclipped mascot are not being drawn back into Figma. Where they differ from a Figma frame, the prototype stays as built and `component-gaps.md` records the difference.
